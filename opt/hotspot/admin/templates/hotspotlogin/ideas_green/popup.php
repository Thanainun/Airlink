...
<div id="tabs" style="height:98%; text-align:left; overflow:auto;">
	<ul>
		...
		<li><a href="#tab2">รายละเอียด</a></li>
		<li><a href="#tab3">เปลี่ยนรหัส</a></li>
        <li><a href="#tab4">ข่าวสาร</a></li>
		<li><a href="#tab5">แจ้งปัญหา</a></li>
	</ul>
	...
	<div id="tab1">
		<div align="center" style="height:75px;">
			<div class="m_form">
				...
				<div class="mmo_txt"> 		เพ็คเก็ตที่ใช้ <div rel="plan_name"> </div>  </div> 
				<div id='time_count' class="mmo_txt countdown_section">กำลังตรวจสอบข้อมูล<br/>..กรุณารอสักครู่..</div></td></tr></table><br/>
				 <div class="mmo_txt"> วันหมดอายุ <div rel="end_time"></div>  </div>  
			</div>
		...
		<div class="popup_notice">
			...
			<div rel="reply"></div>
			<div rel="dynamic_content" class="mmo_notice_bd" style="height:65px; padding-top:40px;">
				<!-- ---- ข้อความระบบ ---- -->
			</div>
			{popup_content}
		</div>   
           <div class="serv_content" align="center">
          
          <p> <p><a href="/hotspot/index.php/dashboard" class="contact_btn" target="_blank"><i class="icon-shopping-cart"></i>&nbsp;ข้อมูล User นี้และรายละเอียดส่วนจัดการผู้ใช้งาน</a>&nbsp;
             <a href="/hotspot/index.php/topup" class="contact_btn" target="_blank"><i class="icon-shopping-cart"></i>&nbsp;เติมเงินด้วยบัตร WiFi</a></p>
          <p><a href="http://1.1.1.1" id="halt" class="contact_btn"><i class="icon-off"></i>&nbsp;ออกจากระบบ</a></p>
	...
	<div id="tab4"> <div rel="announced">{popup_announced}</div> </div>
	<div id="tab5"> <div rel="contractform"></div> </div>
