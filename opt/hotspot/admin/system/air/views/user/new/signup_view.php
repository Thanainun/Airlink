...
<div class="separator"></div>
	...
	<div class="widget widget-4">
		<div class="widget-head">
			<h3 class="heading">Airlink Registration Area!</h3>
		</div>
		<div class="widget-body">
			<p>Airlink WiFi ให้บริการอินเทอร์เน็ตสารธารณะสำหรับทุกคน</p>
		</div>
	</div>
		...
		<div class="widget-body" style="padding: 10px 0 0;">
                            ...
                            <?=form_open($this->uri->segment(1).'/','id="form" class="form-horizontal" autocomplete="off"')?>
																			<header><div class="login-hd">ระบบสมัครสมาชิกเพื่อทดลองใช้งาน Airlink</div></header>
																			 <hr />
