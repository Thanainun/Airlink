...
Class Onlineusermodel extends CI_Model {
	function __construct()
	{
		...
		$this->aColumns = array('ra.radacctid','ra.username', 'ap.location', 'ap.name', 'ra.acctstarttime', 'ra.acctsessiontime', 'ra.acctoutputoctets' );
	...
	function data_table()
	{
		...
		{	
			...
			$jdata[] .= anchor('admin/onlineuser/disconnect/'.$row->username,'<img width="16" height="16" src='.other_asset_url('delete.gif','','images').'>','class="disconnect"');
