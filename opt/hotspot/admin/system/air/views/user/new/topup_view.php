            ...
            <div class="row">
					...
					<div class="five columns news-col">
						...
						<?=form_open($this->uri->segment(1).'/','id="form" class="login-box-top"')?>
								...
								<?=form_input(array('name'=>'user','type'=>'text','minlength'=>'13'),'','  required="required" id="user" placeholder='.$this->lang->line('topup_user_name').'')?>
								<?=form_input(array('name'=>'pass','type'=>'text','minlength'=>'13'),'','  required="required" id="pass" placeholder='.$this->lang->line('topup_user_pass').'')?>
							  
                                  <?=$error2?>
                               <br />
                               <p>
                                <?=form_input(array('name'=>'user_card','type'=>'text','minlength'=>'13'),'','  required="required" id="user_card" placeholder='.$this->lang->line('topup_user_nameoncard').'')?>
                              
                                <?=form_input(array('name'=>'pass_card','type'=>'text','minlength'=>'13'),'','  required="required" id="pass_card" placeholder='.$this->lang->line('topup_user_passoncard').'')?>
					    </p>
