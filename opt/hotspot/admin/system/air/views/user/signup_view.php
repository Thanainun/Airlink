...
<div class="separator"></div>
	...
	<div class="widget widget-4">
		<div class="widget-head">
			<h3 class="heading">DuyDui Registration Area!</h3>
		</div>
		<div class="widget-body">
			<p>DuyDui WiFi ให้บริการอินเทอร์เน็ตสารธารณะสำหรับทุกคน</p>
		</div>
	</div>
		...
		<div class="widget-body" style="padding: 10px 0 0;">
                            ...
                            <?=form_open($this->uri->segment(1).'/','id="form" class="form-horizontal" autocomplete="off"')?>
																			<header><div class="login-hd">ระบบสมัครสมาชิกเพื่อทดลองใช้งาน DuyDui  WiFi</div></header>
																			 <hr />
                                ...
                                <fieldset>
                                    <dl><dt></dt><dd><label>ชื่อผู้ไช้(ภาษาอังกฤษหรือตัวเลข) *</label><?=form_input('username','','type="text" maxlength="70" required="required" id="username"')?></dd>
                                        ...
                                        <dt></dt><dd><label><?=$this->lang->line('user_form_label_personal_id')?> *</label><?=form_input(array('name'=>'personal_id','type'=>'number','minlength'=>'13'),'',' title="รหัสประจำตัวประชาชน" id="personal_id"')?></dd>
                                ...
                                <fieldset>
                                    <dl>
                                        ...
                                        <dt></dt><dd><label><?=$this->lang->line('user_form_label_phone')?></label><?=form_input(array('name'=>'phone','type'=>'number'),'')?></dd>
										<dt></dt><dd><label><?=$this->lang->line('user_form_label_email')?></label><?=form_input(array('name'=>'email','type'=>'email'),'',' maxlength="75" id="email"')?></dd>
                                ...
                                <fieldset>
                                    <dl>
                                        <dt></dt><dd><label><?=$this->lang->line('user_form_label_address')?><em>[Ex. 338/373 ]*</em></label><?=form_input('address1','','type="text" required="required"')?></dd>
										<dt></dt><dd><label> <em>ตึกที่  [ Ex. 9- 23]*</em></label><?=form_input('address2','','type="text" required="required" id="address2"')?></dd>
