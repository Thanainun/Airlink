...
<div class="row">
					...
					<div class="five columns news-col">
                                ...
                                <p><a href="http://www.google.co.th" class="button">Go! login</a></p>
							</div>
                        </div>
                    </div>
		...
		<div class="container">
		  <div class="row sixteen columns title-row">
            ...
            <div class="row">
					...
					<p>
					<?=form_input(array('name'=>'user','type'=>'text','minlength'=>'13'),'',' required="required" id="user" autocomplete="off" placeholder='.$this->lang->line('clear_user_name').'')?>
					</p>
                    <p>
					<?=form_input(array('name'=>'pass','type'=>'text','minlength'=>'13'),'',' required="required" id="pass" autocomplete="off" placeholder='.$this->lang->line('clear_user_pass').'')?>
						</p>	 
