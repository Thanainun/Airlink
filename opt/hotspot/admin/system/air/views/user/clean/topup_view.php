...
<? if ($complate) { ?>
	...
	<? } else {?>
                    ...
                    <div class="columns">
						...
						<header><div class="login-hd">ระบบเติมเงินด้วยบัตร DUYDUI WIFI</div></header>
						<hr />
							<center><p>ท่านสามารถ เติมเวลาให้ รหัสเก่าของท่าน ด้วยบัตร DuyDui WIFI ท่านสมมารถหาซื้อได้ที่ 0929950442 </p></center>
						...
						<table width="25%" class="full">
                              ...
                              <tr>
                                ...
                                <td><?=form_input(array('name'=>'user_card','type'=>'text','minlength'=>'13'),'',' title="รหัสบัตร User DUYDUI WIFI ที่จะใช้เติม" required="required" id="user_card"')?></td>
                              </tr>
                              <tr>
                                <td ><label>รหัสผ่าน(บัตร)</label></td>
                                <td><?=form_input(array('name'=>'pass_card','type'=>'text','minlength'=>'13'),'',' title="รหัสบัตร Password DUYDUI WIFI ที่จะใช้เติม" required="required" id="pass_card"')?></td>
                              </tr>
                            </table>
					      <hr />
						<div class="clear"></div>	
