...
DuyDui Wifi Hotspot <strong>Solfware Version '.AL_VERSION.'</strong> &amp; Core Version '.CI_VERSION.'  | โปรแกรมนี้ใช้สัญญาอนุญาตครีเอทีฟคอมมอนส์   "สงวนลิขสิทธิ์บางประการ"   2013.   Some rights reserved. ผู้พัฒนา :  '.DEVELOPER.' <a href="donate" id="iframe_fancybox">        สนับสนุนโปรแกรม</a> 
